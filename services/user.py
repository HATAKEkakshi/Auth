...
class UserService:
    ...
    async def _add(self, user_data: User, request: Request, collection_name: str, redis_key_prefix: str):
        redis = request.app.state.redis
        ...
        return {"message": "User created successfully", "Email": user_data.email,"id": user_id}
